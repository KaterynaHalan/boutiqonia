...
jQuery(document).ready(function() {
    jQuery('.slogan_main').slogan_main();
    jQuery('.slogan_social').slogan_social();
    jQuery('#social_media').social_media();
});
...
jQuery.fn.extend({
    social_media: function() {
        return this.each(function() {
            ...
            jQuerythis.html(html);
            if(counter==1){jQuery("#social_media").css('width', "40px"); }
            else if(counter==2){jQuery("#social_media").css('width', "80px"); }
            else if(counter==3){jQuery("#social_media").css('width', "120px"); }
            else if(counter==4){jQuery("#social_media").css('width', "160px"); }
            else if(counter==5){jQuery("#social_media").css('width', "200px"); }
            else if(counter==6){jQuery("#social_media").css('width', "240px"); }
            else if(counter==7){jQuery("#social_media").css('width', "280px"); }
